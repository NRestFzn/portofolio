...
const SocialMedia = [
  {
    ...
    name: 'Email',
    link: 'emailto:lnashirresta7@gmail.com',
  },
  {
    id: 2,
    icon: <FaLinkedin className={iconStyle} />,
    name: 'Linkedin',
    link: 'hhttps://www.linkedin.com/in/nashir-resta-200ba224b/',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    name: 'Instagram',
    link: 'https://www.instagram.com/restfzn_/',
  },
  {
    id: 5,
    icon: <SiGithub className={iconStyle} />,
    name: 'Github',
    link: 'https://github.com/NRestFzn',
  },
];
    ...
    <div className="bg-white p-5">
      <div className="bg-secondary rounded-lg px-16 max-lg:px-8">
        ...
        <div className="flex items-center justify-center py-3">
          <Text className="text-white text-sm">NashirRestaFauzian - 2025</Text>
        </div>
      </div>
    </div>
  );
